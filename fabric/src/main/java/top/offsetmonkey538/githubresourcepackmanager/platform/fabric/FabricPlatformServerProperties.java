...
public class FabricPlatformServerProperties implements PlatformServerProperties {
    ...
    public String getResourcePackUrl() {
        final Optional<MinecraftServer.ServerResourcePackProperties> resourcePackProperties = FabricPlatformMain.INSTANCE.getServer().getResourcePackProperties();
    ...
    public String getServerPort() {
        return String.valueOf(FabricPlatformMain.INSTANCE.getServer().getServerPort());
    }
